...
def launch_setup(context, *args, **kwargs):
        ...
        parameters=[
            ...
            {"joint_controller_active": activate_joint_controller},
            {
                "consistent_controllers": [
                    ...
                    "gripper_action_controller",  # <-- Added this from your edit
                ]
            },
        ],
    )
    ...
    delayed_ur_control_node = TimerAction(
    ...
    nodes_to_start = [
        control_node,
        #ur_control_node,  # <-- This is removed from the list
        delayed_ur_control_node,  # <-- This delayed version is added
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [
                    ...
                    "robot_calibration.yaml",  ################ changed here
                ]
            ),
